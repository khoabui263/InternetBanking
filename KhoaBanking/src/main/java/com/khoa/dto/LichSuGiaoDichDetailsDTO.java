...
public class LichSuGiaoDichDetailsDTO {
	private int id;
	...
	public String getTennganhanggui() {
		return tennganhanggui;
	}
	public void setTennganhanggui(String tennganhanggui) {
		this.tennganhanggui = tennganhanggui;
	}
	...
	public String getTennganhangnhan() {
		return tennganhangnhan;
	}
	public void setTennganhangnhan(String tennganhangnhan) {
		this.tennganhangnhan = tennganhangnhan;
	}
