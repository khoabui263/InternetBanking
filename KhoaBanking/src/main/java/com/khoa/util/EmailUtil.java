	...
	public int transfer(String otp, String receiveEmail, String loaiEmail) {
        ...
        try {
			...
			case EmailTypesConstant.CHANGE_PASSWORD:
				String htmlContent = "<h2>Đây là mail xác nhận đổi mật khẩu</h2>" +
	                    				"Mã xác nhận otp của bạn là: " + otp + "<strong style='margin-left: 10px; color: red'>Lưu ý: Mã OTP này chỉ có hiệu lực trong vòng 1 tiếng</strong>";
